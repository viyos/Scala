...
def main(args: Array[String]) = {
   ...
   val set_linguagens = Set("C", "C++", "Java", "Scala", "PHP", "Python") //Set imutavel
   ...
   println("Set Mutável:")
   var numeros_mut = scala.collection.mutable.Set[Int](1, 6, 2, 12, 7, 3, 11) //Set mutavel
   numeros_mut += (10,50) //Acrescentado no set os numeros 10 e 50
   numeros_mut.foreach((item:Int) => println(item))

   println("Exemplo 3:")
   
   // Vamos ordenar o set anterior
   val numeros_sorted: SortedSet[Int] = SortedSet[Int]() ++ numeros_mut //Comando para ordenar
   ...
   println( "Os elementos em comum aos sets são: " + conjunto1.intersect(conjunto2) ) //Elementos comuns entre os sets
