...
def main(args: Array[String]) = {
   ...
   val soma = t._1 + t._2 + t._3 + t._4 //Chamando os objetos pelo indica (t._1 é o primeiro indice da tupla)
   ...
   val tupla = new Tuple3(10, "hello", 'A') //Para criar umas tupla de 3 elementos Tuple3 de 4 elementos Tuple4 ...
   ...
   t_num.productIterator.foreach { i => println("Valor = " + i )} //É necessario utilizar productIterator no foreach para tuplas
   ...
   // Loop para imprimir cada elemento da tupla invertendo a ordem
